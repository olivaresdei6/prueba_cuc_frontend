  ...
  <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-roboto">
    ...
    <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <div className='relative z-10 flex-shrink-0 flex h-16 shadow'>
          ...
          <button className="btn_agregar rounded-full bg-indigo-600 text-white font-bold py-2 px-4 m-4">
            <svg className="w-6 h-6 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              Add
            </svg>
            Agregar
          </button>
          {/* Boton n grande que diga editar, redondo y con un icono de lapiz y el texto editar. Todo centrado, con padding y margen */}
          <button className="btn_editar rounded-full bg-indigo-600 text-white font-bold py-2 px-4 m-4">
            <svg className="w-6 h-6 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              Edit
            </svg>
            Editar
