...
function App() {
  ...
  <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-roboto">
    ...
    <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <div className='relative z-10 flex-shrink-0 flex h-16 shadow items-center justify-between px-4 bg-white dark:bg-gray-800'>
          ...
          <div className="flex justify-center items-center h-screen">
            <button className="bg-gradient-to-r from-purple-800 to-purple-500 text-white rounded-lg py-3 px-6 shadow-md hover:shadow-lg">
