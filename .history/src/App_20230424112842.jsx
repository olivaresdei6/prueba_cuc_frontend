  ...
  <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-roboto">
    ...
    <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <div className='relative z-10 flex-shrink-0 flex h-16 shadow'>
          ...
          <button className="px-4 border border-transparent text-gray-500 bg-white rounded-l-md hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
