  ...
  <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-roboto">
    ...
    <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <div className='relative z-10 flex-shrink-0 flex h-16 shadow'>
            <button className="btn_programas bg-indigo-600 dark:bg-indigo-900 text-white px-4 py-2 m-2 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-800">
                Programas
            </button>

            <button className="btn_asignaturas bg-indigo-600 dark:bg-indigo-900 text-white px-4 py-2 m-2 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-800">
                Asignaturas
            </button>

            <button className="btn_docentes bg-indigo-600 dark:bg-indigo-900 text-white px-4 py-2 m-2 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-800">
                Docentes
            </button>

            <button className="btn_grupos bg-indigo-600 dark:bg-indigo-900 text-white px-4 py-2 m-2 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-800">
                Grupos
            </button>

            <button className="btn_estudiantes bg-indigo-600 dark:bg-indigo-900 text-white px-4 py-2 m-2 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-800">
                Estudiantes
            </button>
            
            <button className="btn_calificaciones bg-indigo-600 dark:bg-indigo-900 text-white px-4 py-2 m-2 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-800">
                Calificaciones
            </button>
        </div>
