...
const ProgramaAcademico = () => {
    ...
    const guardarProgramaAcademico = (e) => {
        e.preventDefault();
        console.log("Se presiono el boton de guardar");
        setModalIsOpen(false);
        const url = 'http://localhost:3008/api/v1/programa_academico';
        ...
        console.log('====================================');
        console.log('Se guardo el programa academico: \n', data);
        console.log('====================================');
    }
                ...
                <div className="flex justify-center items-center h-screen">
                    ...
                    { modalIsOpen &&
                        ...
                        >
                            ...
                            <form className="flex flex-col w-full mt-6" onSubmit={guardarProgramaAcademico}>
