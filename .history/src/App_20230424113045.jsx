  ...
  <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-roboto">
    ...
    <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <div className='relative z-10 flex-shrink-0 flex h-16 shadow'>
          { /* Boton de agregar en grande con bordes sutilmente redondeados, se muestra en la parte superior izquierda */ }
          { /* Se muestra el boton de agregar, super grande, con bordes sutilmente redondeados, con un icono y text de agregar, todo centrado */ }
          <button className="btn_agregar bg-indigo-600 dark:bg-indigo-900 hover:bg-indigo-700 dark:hover:bg-indigo-800 text-white font-bold py-2 px-4 rounded-l">
