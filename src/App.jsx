    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-roboto">
        ...
        <div className="flex flex-col h-0 flex-1 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          ...
          <div className="flex-1 flex flex-col overflow-y-auto">
            <nav className="flex-1 px-2 py-4 bg-white dark:bg-gray-800 space-y-1">
              <ButtonSidebar
                  nombre={"Programa academico"} handleClick={handleClick} classButton={"btn_programas"}/>
      ...
      <div className="flex flex-col w-0 flex-1 overflow-hidden">
        <main className="flex-1 relative overflow-y-auto focus:outline-none">
            ...
            { buttonName === "btn_asignaturas" && <Asignatura />}
            { buttonName === "btn_docentes" && <Docente /> }
            { buttonName === "btn_grupos" && <Grupo />}
            { buttonName === "btn_estudiantes" && <Estudiante/> }
            { buttonName === "btn_calificaciones" && <Calificacion/> }
        </main>
      </div>
    </div> /* Fin del div que contiene la sidebar */
  )
